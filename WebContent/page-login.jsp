			...
			<div class="sticky-menu">
				...
				<nav class="main-nav">
						<ul class="clear-fix">
							...
							<li>
								<a href="courses-grid.html">Cours</a>
								<!-- sub menu -->
							...
							<li class="megamenu">
								<a href="content-elements.html">Forum</a>
							</li>
							<li>
		...
		<section class="fullwidth-background bg-2">
			<div class="grid-row">
				<div class="login-block">
					...
					<s:form name="login-form" class="login-form" action="personneaction" method="post">
					
						<div class="form-group">
						<!--USERNAME--><input type="text" placeholder="Login"  name="login"  class="login-input" required title="Login is required!" x-moz-errormessage="Login is required" /><!--END USERNAME-->
							<span class="input-icon">
								<i class="fa fa-user"></i>
							</span>
						</div>
						<div class="form-group">
							<!--PASSWORD--><input type="password" placeholder="Mot de passe" name="password" class="login-input" required title="Password is required!" x-moz-errormessage="Password is required" /><!--END PASSWORD-->
						...
						<input type="submit"  name="submit" value="LOG IN" onclick="nomUser()" class="button-fullwidth cws-button bt-color-3 border-radius alt"/>
			...
			<div class="grid-row clear-fix">
				...
				<nav class="footer-nav">
					<ul class="clear-fix">
						...
						<li>
							<a href="blog-default.html">Forum</a>
						</li>
