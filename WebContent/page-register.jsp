				...
				<div class="login-block">
					...
					<s:form name="login-form" class="login-form" action="inscriptionaction" method="post">
						<div class="form-group">
							<input type="text" class="login-input" name ="login" placeholder="Nom d'utilisateur" required title="Login is required!" x-moz-errormessage="Login is required" />
							<span class="input-icon">
								<i class="fa fa-user"></i>
							</span>
						</div>
						<div class="form-group">
						<input type="text" class="login-input" name ="email" placeholder="Email" required title="Email is required!" x-moz-errormessage="Email is required" />
						...
						<div class="form-group">
							<input type="password" class="login-input" name="password" placeholder="Mot de passe" required title="Password is required!" x-moz-errormessage="Password is required" />
							<span class="input-icon">
